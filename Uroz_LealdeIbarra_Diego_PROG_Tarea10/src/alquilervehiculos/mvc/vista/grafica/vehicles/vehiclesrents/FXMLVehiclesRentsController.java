...
public class FXMLVehiclesRentsController
{
    ...
    private void handleScreenButtonsAction(ActionEvent event) throws IOException
    {
        ...
        {
            loadScene(event, "../FXMLVehiclesSearch.fxml");
        }
    }
    ...
    @FXML
    public void initData(Vehiculo vehiculo)
    {
        this.stringMatricula = vehiculo.getMatricula();
    }
    ...
    public void initialize()
    {
        ...
        {
            Mensajes.mostrarError("Vehículos", "Sin alquileres");
        }
    }

    private void listarAlquileres() throws IOException
    {
        ObservableList<Alquiler> alquileres = FXCollections.observableArrayList(JavaFXMainStage.controlador.obtenerAlquileresVehiculo(stringMatricula));
